...
html_theme_options = {
    "external_links": [
      ...
      ("Impressum", "https://jagdkataster.org/impressum"),
      ("Datenschutz", "https://jagdkataster.org/datenschutz"),
      ("GitHub", "https://github.com/skorpsim/JagdKataster/tree/master/huntregister")
  ]
}
...
# of the sidebar.
html_logo = '_static/svg/logo_text.svg'
...
html_sidebars = {'**': ['util/searchbox.html', 'util/sidetoc.html', 'sidedonate.html']}

html_baseurl = 'https://jagdkataster.org'
